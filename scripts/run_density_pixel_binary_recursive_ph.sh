...
CONFIG="${CONFIG:-configs/dnb_density_unet_probability_field_recursive_ph_20260610.json}"
SCENE_SPLIT_CSV="${SCENE_SPLIT_CSV:-outputs/dnb_density/splits/ox_spatial_25pct_63_15_14_20260609_011421/scene_split.csv}"
RUN_TAG="${RUN_TAG:-probability_field_recursive_ph_min3_$(date +%Y%m%d_%H%M%S)}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/dnb_density/runs/${RUN_TAG}}"
PATCH_CACHE_DIR="${PATCH_CACHE_DIR:-outputs/dnb_density/patch_caches/probability_field_recursive_ph_min3_20260610}"
